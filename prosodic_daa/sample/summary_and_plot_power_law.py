...
def get_labels(names, dataset_dir):
    letter_labels = [np.loadtxt(dataset_dir + "LABEL/" + name + ".lab") for name in names]
    word_labels = [np.loadtxt(dataset_dir + "LABEL/" + name + ".lab2") for name in names]
    return letter_labels, word_labels

def get_datas_and_length(names, dataset_dir):
    datas = [np.loadtxt(dataset_dir + "DATA/" + name + ".txt") for name in names]
...
datas, length = get_datas_and_length(names, dataset_dir)
l_labels, w_labels = get_labels(names, dataset_dir)
