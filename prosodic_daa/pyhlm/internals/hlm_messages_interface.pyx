...
def internal_messages_forwards_log_prosody(
        floating[:,::1] apBl not None,
    ...
    ref.internal_messages_forwards_log_prosody(
        alphal.shape[0], alphal.shape[1], apBl.shape[1], aDl.shape[1], state,
        &apBl[0, 0], &aDl[0, 0], &alphal[0, 0])
